...
public class MyPanel extends JPanel implements KeyListener {
    ...
    public void paint(Graphics g) {
        ...
        drawBullet(hero.getmYBulletBullet(), g, 0);
        hero.shot();
    ...
    private void drawBullet(Bullet bullet, Graphics g, int direction) {
        switch (direction) {
            case 0://方向向上
                g.fill3DRect(bullet.getX() + 15, bullet.getY() - 10, 10, 10, false);
                break;
            case 1://方向向右
                break;
            case 2://方向向下
